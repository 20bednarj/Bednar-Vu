...
GusTop5Audio <-
  ...
  summarise(danceability = sum(danceability)/5,energy = sum(energy)/5,speechiness = sum(speechiness)/5,acousticness = sum(acousticness)/5) 

#Make new data frame so we can graph easier
Audio_Features <- c("danceability", "energy", "speechiness", "acousticness")
Score <- c(402.590400, 408.287008, 158.053660, 91.696080)
...
#Make new data frame so we can graph easier
JAudio_Features <- c("danceability", "energy", "speechiness", "acousticness")
JScore <- c(208.6264, 178.6905, 65.90458, 51.64297)
