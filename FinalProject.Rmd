...
ggplot(GusCoPlay) +
  ...
  geom_bar() +
  scale_fill_hue(direction = 1) +
  labs(title = "Gus' Top 10 Songs On CoPlayList") +
  coord_flip() +
  theme_bw()
...
ggplot(JeremyCoPlay) +
  ...
  geom_bar() +
  scale_fill_hue(direction = 1) +
  labs(title = "Jeremy's Top 10 Songs On CoPlayList") +
  coord_flip() +
  theme_bw()
...
```{r}
get_track_audio_features("3aJ66zarLOVW4o2nPDxg0g", authorization = access_token)
```
