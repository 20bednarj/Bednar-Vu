...
#Audio_Features = t(GusTop5Audio)
#Gus_Top_5Audio <- data.frame(Audio_Features) %>%
#  group_by(AudioFeatures)
...
JeremyfavArtist1 <- get_artist_audio_features(artist= "Ms. Lauryn Hill")
JeremyfavArtist2 <- get_artist_audio_features(artist= "Erykah Badu")
JeremyfavArtist3 <- get_artist_audio_features(artist= "2Pac")
JeremyfavArtist4 <- get_artist_audio_features(artist= "Lil Wayne")
JeremyfavArtist5 <- get_artist_audio_features(artist= "Jay-Z")
